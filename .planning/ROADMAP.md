...
Plans:
- [ ] 01-01: Scaffold Next.js (App Router) + TS + pnpm + lint/teste base + git
- [ ] 01-02: Design system base + layout/nav/menus (docs: "Arquitetura de menus") + APP_MODE toggle
- [ ] 01-03: Rotas 11 P0 + 5 condomínios com conteúdo mínimo e SEO técnica (metadata, sitemap, robots, schema)
