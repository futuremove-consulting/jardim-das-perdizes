...
/**
 * Dedicated brand OG image (1200x630), generated by
 * scripts/generate-og-image.py (photo of the Tomie Ohtake sculptures in the
 * central park + brand tokens). Regenerate after brand/copy changes.
 */
